...
tar -xf bat-v0.22.1-x86_64-unknown-linux-musl.tar.gz

CONF=$(~/bat-v0.22.1-x86_64-unknown-linux-musl/bat --config-dir)
mkdir $CONF
...
~/bat-v0.22.1-x86_64-unknown-linux-musl/bat cache --build 
